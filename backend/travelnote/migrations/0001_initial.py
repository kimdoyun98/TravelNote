# Generated by Django 3.0.14 on 2023-07-26 14:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag_set', models.ManyToManyField(blank=True, to='travelnote.Tag')),
            ],
            options={
                'ordering': ['-id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='travelnote.Post')),
            ],
            options={
                'ordering': ['-id'],
            },
